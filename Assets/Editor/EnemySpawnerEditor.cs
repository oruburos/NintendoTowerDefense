...
[CustomEditor(typeof(EnemyWaveScheduler))]
class EnemySpawnerEditorr : Editor
{
    ...
    {
        list = new ReorderableList(serializedObject, serializedObject.FindProperty("EnemyWaves"), true, true, true, true);
        ...
        list.drawHeaderCallback = (Rect rect) => {
            EditorGUI.LabelField(new Rect(rect.x + 13, rect.y, 30, rect.height), "#num");
            EditorGUI.LabelField(new Rect(rect.x + 13 + 35, rect.y, rect.width - 35 - 70 - 65, rect.height), "enemy");
            EditorGUI.LabelField(new Rect(rect.x + rect.width - 70 - 65, rect.y, 60, rect.height), "appearing");
            EditorGUI.LabelField(new Rect(rect.x + rect.width - 65, rect.y, 60, rect.height), "rest");
        };
